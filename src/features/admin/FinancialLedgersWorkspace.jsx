...
import { approveContractorPayable, fetchFinancialLedgers, outstandingPayables } from "../../lib/serviceosFinancialLedgers.js";
...
export default function FinancialLedgersWorkspace({ revenueContext }) {
  ...
  const [data, setData] = useState(null), [error, setError] = useState(""), [loading, setLoading] = useState(true), [busyId, setBusyId] = useState("");
  ...
  return <div className="financial-ledgers-workspace" aria-busy={loading}>
    ...
    <PayableSettlementBoard rows={data?.payables?.rows} currencyCode={currencyCode} roleCode={revenueContext?.roleCode} busyId={busyId} onApprove={approve} />
