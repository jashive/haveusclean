...
const css = `
  ...
  @media(max-width:650px){.huc-apply{padding:22px 12px 36px}.huc-market-grid,.huc-form-grid{grid-template-columns:1fr}.huc-field-wide,.huc-section,.huc-submit{grid-column:auto}.huc-apply-card{border-radius:15px}}
`;
